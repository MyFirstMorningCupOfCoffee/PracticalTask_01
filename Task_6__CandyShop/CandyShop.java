...
class CandyShop
{
    ...
    private static void startDialog()
    {
        ...
        double quantity_chocolate, quantity_chewing, cost_chocolate, cost_chew;
        ...
        cost_chocolate = readDoubleFromConsole();
        ...
        double chocolatePrice = calculatePrice(cost_chocolate, quantity_chocolate);
